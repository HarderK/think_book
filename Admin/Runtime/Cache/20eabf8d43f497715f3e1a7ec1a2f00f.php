                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["bno"]); ?>" type="checkbox"></td>
                            <td><?php echo ($i); ?></td>
                            <td title="<?php echo ($vo["title"]); ?>"><?php echo (subtxt($vo["title"],10)); ?></td>
                            <td><?php echo ($vo["isbn"]); ?></td>
                            <td title="<?php echo ($vo["author"]); ?>"><?php echo (subtxt($vo["author"],10)); ?></td>
                            <td><?php echo ($vo["publisher"]); ?></td>
                            <td><?php echo ($vo["pubDate"]); ?></td>
                            <td>￥<?php echo ($vo["price"]); ?></td>
							<?php if($vo["type"] == 1): ?><td>计算机</td>
                            ...
                            <td>
                                <a class="link-update" href="__APP__/Index/myUpdate?id=<?php echo ($vo["bno"]); ?>">修改</a>
                                <a class="link-del" href="__APP__/Index/del1?id=<?php echo ($vo["bno"]); ?>">删除</a>
                            </td>
